...
class _MCPCatalog:
    ...
    async def reconcile(
        ...
        mcp_directory = capability_view.repertoire / _MCP_DIRECTORY
        configs = _valid_configs(mcp_directory, on_diagnostic)
...
def _valid_configs(
    ...
    A missing or structurally invalid config is reported through
    ``on_diagnostic`` and produces no projection.
    """
